...
dns_wedos_add() {
  ...
  response=
  if _wedos_rest '{ "request": {"user": "'"$WEDOS_User"'", "auth": "'"$WEDOS_Token"'", "command": "dns-row-add", "data": { "domain": "'"$_domain"'", "name": "'"_acme-challenge"'", "ttl": "600", "type": "TXT", "rdata": "'"$txtvalue"'" }}}'; then
    _info "Added, OK"
